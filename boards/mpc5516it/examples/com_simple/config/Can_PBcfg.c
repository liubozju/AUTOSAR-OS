...
PduIdType  Can_swPduHandles_Controller_A[1];

// NEW
const uint8 Can_MailBoxToHrh_Controller_A[]= {
	0,
	0,
	0,
	0,
...
{  
  {
    ...
    .CanControllerSeg2 =		4,
    .CanControllerRJW =			0,
    .Can_Arc_Flags =			(CAN_CTRL_BUSOFF_PROCESSING_INTERRUPT | CAN_CTRL_RX_PROCESSING_INTERRUPT | CAN_CTRL_TX_PROCESSING_INTERRUPT | CAN_CTRL_WAKEUP_PROCESSING_INTERRUPT | CAN_CTRL_ERROR_PROCESSING_INTERRUPT | CAN_CTRL_ACTIVATION | CAN_CTRL_FIFO),
    ...
    .Can_Arc_MailBoxToHrh =     Can_MailBoxToHrh_Controller_A,
    .Can_Arc_TxPduHandles =     Can_swPduHandles_Controller_A,
